...
function scene:create( event )
	...
	floor3.name = "floor3"
	floor3.class = "floor"
	floor3.x, floor3.y = 230, 1200
	physics.addBody( floor3, "static", { friction=0.3 } )

	local floor4 = display.newImageRect( "Images/tile320.png", 620, 420 )
	floor4.anchorX = 0
	floor4.anchorY = 1
	floor4.name = "floor4"
	floor4.class = "floor"
	floor4.x, floor4.y = 840, 1200
	...
	local breakable = display.newImageRect( "Images/breakable.png", 60, 390 )
	breakable.anchorX = 0
	breakable.anchorY = 1
	breakable.name = "breakable"
	breakable.class = "breakable"
	breakable.x, breakable.y = 650, 775
	...
	local platform1 = display.newImageRect( "Images/dirtPlatform.png", 200, 70 )
	platform1.anchorX = 0
	platform1.anchorY = 1
	platform1.name = "platform1"
	platform1.class = "floor"
	platform1.x, platform1.y = 1720, 350
	...
	platform2.x, platform2.y = 1425, -120
	physics.addBody( platform2, "static", { friction=0.3 } )

	local platform3 = display.newImageRect( "Images/dirtPlatform.png", 800, 70 )
	platform3.anchorX = 0
	platform3.anchorY = 1
	platform3.name = "platform3"
	platform3.class = "floor"
	platform3.x, platform3.y = 640, 380
	physics.addBody( platform3, "static", { friction=0.3 } )

	local platform4 = display.newImageRect( "Images/dirtPlatform.png", 70, 250 )
	platform4.anchorX = 0
	platform4.anchorY = 1
	platform4.name = "platform4"
	platform4.class = "floor"
	platform4.x, platform4.y = 0, 860
	physics.addBody( platform4, "static", { friction=0.3 } )

	local platform5 = display.newImageRect( "Images/dirtPlatform.png", 150, 70 )
	platform5.anchorX = 0
	platform5.anchorY = 1
	platform5.name = "platform5"
	platform5.class = "floor"
	platform5.x, platform5.y = 250, 530
	physics.addBody( platform5, "static", { friction=0.3 } )

	-- Position the omskites
	local omskite1 = generateOmskite( 1850, 10)
