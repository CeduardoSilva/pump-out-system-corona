...
function scene:create( event )
	...
	floor3.name = "floor3"
	floor3.class = "floor"
	floor3.x, floor3.y = 230, 1400
	physics.addBody( floor3, "static", { friction=0.3 } )

	local floor4 = display.newImageRect( "Images/tile320.png", 70, 420 )
	floor4.anchorX = 0
	floor4.anchorY = 1
	floor4.name = "floor4"
	floor4.class = "floor"
	floor4.x, floor4.y = 840, 1400
	...
	floor5.name = "floor5"
	floor5.class = "floor"
	floor5.x, floor5.y = 1460, 1400
	physics.addBody( floor5, "static", { friction=0.3 } )

	local breakable = display.newImageRect( "Images/breakable.png", 60, 650 )
	breakable.anchorX = 0
	breakable.anchorY = 1
	breakable.name = "breakable"
	breakable.class = "breakable"
	breakable.x, breakable.y = 1450, 970
	breakable.collision = breakableCollisionHandler
	breakable:addEventListener( "collision" )
	physics.addBody( breakable, "dynamic", { density = 1, friction=0.6 } )

	local platform1 = display.newImageRect( "Images/dirtPlatform.png", 1000, 70 )
	platform1.anchorX = 0
	platform1.anchorY = 1
	platform1.name = "platform1"
	platform1.class = "floor"
	platform1.rotation = 165
	platform1.x, platform1.y = 1000, 750
	physics.addBody( platform1, "static", { friction=0.3 } )

	local platform2 = display.newImageRect( "Images/dirtPlatform.png", 100, 70 )
	platform2.anchorX = 0
	platform2.anchorY = 1
	platform2.name = "platform2"
	platform2.class = "floor"
	platform2.x, platform2.y = 1550, 770
	physics.addBody( platform2, "static", { friction=0.3 } )

	-- Position the omskites
	local omskite1 = generateOmskite( 1550, 650)
